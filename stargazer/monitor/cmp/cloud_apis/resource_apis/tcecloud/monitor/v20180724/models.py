...
class DescribeBindingPolicyObjectListResponse(AbstractModel):
    ...
    def __init__(self):
        ...
        :type InstanceGroup: :class:`tcecloud.monitor.v20180724.models.DescribeBindingPolicyObjectListInstanceGroup`
        :param RequestId: 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
        self.List = None
...
class DescribePolicyConditionListConfigManual(AbstractModel):
    ...
    def __init__(self):
        """
                :param CalcType: 检测方式
        注意：此字段可能返回 null，表示取不到有效值。
                :type CalcType: :class:`tcecloud.monitor.v20180724.models.DescribePolicyConditionListConfigManualCalcType`
                :param CalcValue: 检测阈值
        注意：此字段可能返回 null，表示取不到有效值。
                :type CalcValue: :class:`tcecloud.monitor.v20180724.models.DescribePolicyConditionListConfigManualCalcValue`
                :param ContinueTime: 持续时间
        注意：此字段可能返回 null，表示取不到有效值。
                :type ContinueTime: :class:`tcecloud.monitor.v20180724.models.DescribePolicyConditionListConfigManualContinueTime`
                :param Period: 数据周期
        注意：此字段可能返回 null，表示取不到有效值。
                :type Period: :class:`tcecloud.monitor.v20180724.models.DescribePolicyConditionListConfigManualPeriod`
                :param PeriodNum: 持续周期个数
        注意：此字段可能返回 null，表示取不到有效值。
                :type PeriodNum: :class:`tcecloud.monitor.v20180724.models.DescribePolicyConditionListConfigManualPeriodNum`
                :param StatType: 聚合方式
        注意：此字段可能返回 null，表示取不到有效值。
                :type StatType: :class:`tcecloud.monitor.v20180724.models.DescribePolicyConditionListConfigManualStatType`
        """
        self.CalcType = None
        self.CalcValue = None
...
class DescribePolicyConditionListMetric(AbstractModel):
    ...
    def __init__(self):
        ...
        注意：此字段可能返回 null，表示取不到有效值。
                :type ConfigManual: :class:`tcecloud.monitor.v20180724.models.DescribePolicyConditionListConfigManual`
                :param MetricId: 指标id
                :type MetricId: int
...
class DescribePolicyGroupInfoResponse(AbstractModel):
    ...
    def __init__(self):
        ...
        :type Callback: :class:`tcecloud.monitor.v20180724.models.DescribePolicyGroupInfoCallback`
        :param ConditionsTemp: 模板策略组
        :type ConditionsTemp: :class:`tcecloud.monitor.v20180724.models.DescribePolicyGroupInfoConditionTpl`
...
class DescribePolicyGroupListGroup(AbstractModel):
    ...
    def __init__(self):
        ...
        注意：此字段可能返回 null，表示取不到有效值。
                :type InstanceGroup: :class:`tcecloud.monitor.v20180724.models.DescribePolicyGroupListGroupInstanceGroup`
...
class DescribeProductEventListResponse(AbstractModel):
    ...
    def __init__(self):
        ...
        :param OverView: 事件统计
        :type OverView: :class:`tcecloud.monitor.v20180724.models.DescribeProductEventListOverView`
        :param Total: 事件总数
        :type Total: int
        :param RequestId: 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
...
class MetricSet(AbstractModel):
    ...
    def __init__(self):
        ...
        :type Meaning: :class:`tcecloud.monitor.v20180724.models.MetricObjectMeaning`
